...
export default function Contact() {
  ...
  return (
    <section id="contacts" className="py-30 px-4 relative overflow-hidden md:px-10">
  {/* Background images */}
  ...
  <div className="mx-auto container relative z-10">
    ...
    <div className="flex flex-col lg:flex-row gap-8 items-start justify-center">
      ...
      <div className="w-full lg:flex-1 lg:max-w-lg order-2">
        <div data-aos="zoom-in" className=" backdrop-blur-md bg-white/90 p-6 md:p-8 rounded-lg shadow-lg relative z-10">
          <Form {...form}>
            <form
      ...
      <div className="flex flex-col gap-8 order-1 md:max-w-xl h-full backdrop-blur-md bg-[#1a1a1a]/20 p-7 rounded-md">
        ...
        <div data-aos="fade-right">
          <h3 className="text-white font-bold text-5xl">Let’s Work Together on Your Next <span className="text-primary">Unit Turnover</span>.</h3>
        </div>

        <div data-aos="fade-right" data-aos-delay="200" className="flex items-start gap-3 text-primary rounded-full w-fit">
        ...
        <div data-aos="fade-right" data-aos-delay="300" className="flex items-center gap-3 text-primary rounded-full w-fit">
          <Phone className="w-5 h-5 text-primary fill-primary stroke-0" />
          <span className="font-medium text-primary text-sm sm:text-base">
            (443) 481-0809
          </span>
        ...
        <div data-aos="fade-right" data-aos-delay="400" className="flex items-center gap-3 text-primary rounded-full w-fit">
          <Mail className="w-5 h-5 text-primary " />
          <span className="font-medium text-primary text-sm sm:text-base">
