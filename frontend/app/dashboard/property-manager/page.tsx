      ...
      <main className="min-h-screen bg-[#121212] text-white">
        <div>
          ...
          <div className="bg-white text-[#1c1c1c] p-2 md:p-8">
            {/* Tabs */}
            <div className=" md:fixed top-23 mt-20 md:mt-0 left-0 right-0 z-20 bg-white md:px-8 py-9 flex flex-col sm:flex-row sm:flex-wrap gap-2 sm:gap-3 items-stretch sm:items-center">
              {(
                [
                  ["orders", "Place Orders"],
                  ["my-orders", "My Orders"],
